var config1 = {
  ...
  chapters: [[
    ...
    },
    {
      ...
      title: '',
      image: '',
      description: '<p>The living conditions of internally displaced populations are increasingly dire.  While most IDPs sites are concentrated around Port-au-Prince there has been a gradual movement to different departments throughout the country and especially to the Grand Sud region where nearly 268,000 displaced individuals reside.  These IDP sites are often overcrowded and lack essential facilities like lighting and latrines. Many face severe shortages of food, water, shelter, and medical care. Approximately 83% of IDPs stay with host families, who often struggle with limited resources. Constraints in humanitarian access make it more difficult to deliver assistance to those in need.</p><p>In Haiti, UN agencies, civil society and local partners are working to address humanitarian needs. These efforts include emergency support and relief in response to natural disasters, improving health care services, addressing food insecurity, a strong emphasis on providing protection services and promoting education and gender equality. In parallel to these efforts, humanitarian partners are focused on promoting stability and sustainable solutions that enhance Haitian capacity and preparedness for future emergencies.</p><div class="legend mb-3"><h5 class="legend-title">Humanitarian access severity</h5><div class="legend-category"><span style="background-color: #FBDADF;"></span>Low</div><div class="legend-category"><span style="background-color: #EF4A60;"></span>Medium</div><div class="legend-category"><span style="background-color: #8F2C39;"></span>High</div></div><p class="text-secondary"><small>Source: <a href="https://reliefweb.int/report/haiti/haiti-apercu-de-la-severite-de-lacces-humanitaire-janvier-juin-2024-26-juillet-2024" target="_blank" rel="noopener noreferrer">OCHA</a></small></p>',
      location: {
        center: [-72.8, 18.88663],
        zoom: 7.5,
        mobileZoom: 6,
...
var config2 = {
  ...
  chapters: [[
    ...
    },
    {
      ...
      title: '',
      image: '',
      description: '<p>Les conditions de vie des populations déplacées à l\'intérieur du pays sont de plus en plus difficiles. Alors que la plupart des sites de déplacés sont concentrés autour de Port-au-Prince, il y a eu un mouvement progressif vers différents départements à travers le pays et en particulier vers la région du Grand Sud où près de 268 000 personnes déplacées vivent actuellement. Ces sites de déplacés sont souvent surpeuplés et manquent de services essentiels tels que l\'éclairage ou des latrines. Beaucoup sont confrontés à de graves pénuries dans les domaines de la nourriture, de l\'eau, des abris et des soins médicaux. Environ 83% des personnes déplacées sont hébergées dans des familles d\'accueil, qui doivent souvent composer avec des ressources limitées. Les contraintes d\'accès rendent plus difficile l\'acheminement de l\'aide humanitaire aux personnes dans le besoin.</p><p>En Haïti, les agences des Nations unies, la société civile et les partenaires nationaux s\'efforcent de répondre aux besoins humanitaires. Ces efforts comprennent un soutien et une aide d\'urgence en réponse aux catastrophes naturelles, l\'amélioration des services de soins de santé, la lutte contre l\'insécurité alimentaire, la fourniture de services de protection et la promotion de l\'éducation et de l\'égalité des sexes. Parallèlement à ces efforts, les partenaires humanitaires s\'attachent à promouvoir la stabilité et à trouver des solutions durables qui renforcent les capacités du pays et le préparent à faire face à de futures situations d\'urgence.</p><div class="legend mb-3"><h5 class="legend-title">Degré de difficulté de l\'accès humanitaire</h5><div class="legend-category"><span style="background-color: #FBDADF;"></span>Faible</div><div class="legend-category"><span style="background-color: #EF4A60;"></span>Moyen</div><div class="legend-category"><span style="background-color: #8F2C39;"></span>Élevé</div></div><p class="text-secondary"><small>Source: <a href="https://reliefweb.int/report/haiti/haiti-apercu-de-la-severite-de-lacces-humanitaire-janvier-juin-2024-26-juillet-2024" target="_blank" rel="noopener noreferrer">OCHA</a></small></p>',
      location: {
        center: [-72.8, 18.88663],
        zoom: 7.5,
        mobileZoom: 6,
    ...
    // },
    {
      ...
      title: '',
      image: '',
      description: '<h5>Haïtiens déracinés sur le continent américain</h5><p>Les destinations les plus courantes pour les Haïtiens fuyant le pays sont les pays des Caraïbes, d\'Amérique du Nord, d\'Amérique centrale et d\'Amérique du Sud.</p><p>La situation en Haïti a donné lieu à différentes phases de déplacement au cours de la dernière décennie, y compris une augmentation des traversées maritimes, comme l\'indique l\'augmentation des interceptions en mer. En 2024, les principales destinations prévues de ces déplacements étaient les Bahamas, les États-Unis et les îles Turks et Caicos, avec d\'autres déplacements à plus petite échelle observés vers d\'autres îles du nord des Caraïbes.</p><iframe title="Nombre de bateaux interceptés en mer" aria-label="Bar Chart" id="datawrapper-chart-9acFh" src="https://datawrapper.dwcdn.net/9acFh/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="215" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"]){var e=document.querySelectorAll("iframe");for(var t in a.data["datawrapper-height"])for(var r=0;r<e.length;r++)if(e[r].contentWindow===a.source){var i=a.data["datawrapper-height"][t]+"px";e[r].style.height=i}}}))}();</script><div class="legend my-3"><h5 class="legend-title">Principaux itinéraires de déplacement par catégorie</h5><div class="legend-category"><span style="background-color: #0072BC;height:.5rem;border-radius:.25rem; vertical-align:baseline;"></span>Terre</div><div class="legend-category"><span style="background-color: #00B398;height:.5rem;border-radius:.25rem; vertical-align:baseline;"></span>Mer</div><div class="legend-category"><span style="background-color: #18375F;height:.5rem;border-radius:.25rem; vertical-align:baseline;"></span>Air</div></div><p class="text-secondary"><small>Source: HCR</small></p>',
      location: {
        center: [-74, 21],
        zoom: 5.3,
        mobileZoom: 4,
