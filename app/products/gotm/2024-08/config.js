var config1 = {
  ...
  chapters: [[
    ...
    },
    {
      ...
      title: '',
      image: '',
      description: '<p>The Darien land route is especially dangerous. In 2023, over 43,000 Haitians nationals crossed the Darien, making Haiti the third most common nationality following Venezuela and Ecuador. This trend has continued into 2024, with over 9,800 irregular crossings reported up to the end of May. Through this land route many reach central American countries, Mexico and the United States.</p><figure class="figure my-4"><img src="RF1338890_67.jpg" class="figure-img img-fluid" alt=""><figcaption class="figure-caption">Panama. Over 11,000 Haitians crossed the Darien in the first 9 months of 2024<br>©UNHCR/Melissa Pinel</figcaption></figure><p>In addition to the challenges posed for people moving in mixed flows, as predominantly Kreyol speakers face language barriers and Haitian asylum-seekers and migrants in the Americas often face compounded barriers to accessing protection and solutions, including discrimination, xenophobia and lack of access to information.</p><div class="legend mb-3"><h5 class="legend-title">Main displacement routes by type</h5><div class="legend-category"><span style="background-color: #0072BC;height:.5rem;border-radius:.25rem; vertical-align:baseline;"></span>Land</div><div class="legend-category"><span style="background-color: #00B398;height:.5rem;border-radius:.25rem; vertical-align:baseline;"></span>Sea</div><div class="legend-category"><span style="background-color: #18375F;height:.5rem;border-radius:.25rem; vertical-align:baseline;"></span>Air</div></div><p class="text-secondary"><small>Source: UNHCR</small></p>',
      location: {
        center: [-81, 8],
        zoom: 6,
        mobileZoom: 4.5,
    ...
    },
    {
      ...
      title: '',
      image: '',
      description: "<h5>Chile</h5><p>Following the 2010 devastating earthquake severely affecting Haiti, Chile adopted different measures to facilitate the regularization of Haitians in their territory including temporary visas and measures to facilitate family reunification. The number of Haitian nationals in Chile have increased sharply since, with 277,075 temporary residence visa applications filed between 2013 and 2023. Many faced challenges with meeting the requirements to apply for permanent residence visas. Nonetheless, in 2023, the number of permanent residency applications made by Haitians ranked second with 25,799 applications.</p>",
      location: {
        center: [-70, -34],
        zoom: 3.5,
        mobileZoom: 2.2,
    ...
    },
    {
      ...
      title: '',
      image: '',
      description: "<h5>Canada</h5><p>The federal government launched a family-based humanitarian pathway to provide permanent residence to Haitian, Colombian, and Venezuelan nationals with family members residing in Canada which benefitted 15,000 people.</p>",
      location: {
        center: [-98, 60],
        zoom: 3.2,
        mobileZoom: 2,
    ...
    },
    {
      ...
      title: '',
      image: '',
      description: "<h5>United States</h5><p>Among the examples from the US, in June 28, 2024, the United States announced the extension and redesignation of Haiti for Temporary Protected Status (TPS) for 18 months, until  3 February, 2026. The redesignation of Haiti for TPS allows an estimated 309,000 additional Haitian nationals to file an application for TPS.</p>",
      location: {
        center: [-98, 38],
        zoom: 3.8,
        mobileZoom: 2.5,
    ...
    },
    {
      ...
      title: '',
      image: '',
      description: '<h5>Other Solutions</h5><p>Several countries in the Americas and beyond are extending various forms of protection and legal stay arrangements to Haitian refugees, including temporary protection, family reunification, humanitarian visas, and access to documentation.</p><p>For example, France has introduced an education program specifically supporting high school-aged Haitian refugees, and The Bahamas amended The Passport Act to provide protocols for children of Bahamian men born to foreign woman in the Bahamas to obtain nationality. The main profile of persons affected by the new legislation are children born to Haitian mothers born in The Bahamas.</p>',
      location: {
        center: [-73, 8],
        zoom: 3,
        mobileZoom: 2,
