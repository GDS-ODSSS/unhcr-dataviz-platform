var config1 = {
  ...
  chapters: [[
    ...
    },
    {
      ...
      title: '',
      image: '',
      description: '<p>Those who continue their journey often move onwards through South and Central America, where they may spend at least 6 months, and in many cases over a year, before heading further north. This northbound movement mainly passes towards Ecuador and Colombia, before leading to the dangerous crossing of the Darién jungle into Panama.</p>',
      location: {
        center: [-72, -9],
        zoom: 4,
        mobileZoom: 0.1,
