...
var config2 = {
  ...
  chapters: [[
    ...
    },
    {
      ...
      title: '',
      image: '',
      description: '<p>La situation sanitaire et en matière de sécurité alimentaire en Haïti sont également à des niveaux critiques. Près de la moitié de la population souffre d\'<a href="https://www.ipcinfo.org/ipc-country-analysis/details-map/en/c/1157971/?iso3=HTI" target="_blank" rel="noopener noreferrer">insécurité alimentaire sévère, avec 2&nbspmillions de personnes se trouvant en situation d\'urgence</a>. Les dernières projections du Cadre intégré de classification de la sécurité alimentaire (IPC) pour septembre 2024 montrent une aggravation de l\'insécurité alimentaire, avec environ 1,2&nbspmillion de personnes supplémentaires confrontées à une insécurité alimentaire aiguë par rapport aux estimations précédentes.</p><div class="legend mb-3"><h5 class="legend-title">Classification de l\'insécurité alimentaire aiguë selon l\'IPC</h5><div class="legend-category"><span style="background-color: #e67700;"></span>Crise - 3</div><div class="legend-category"><span style="background-color: #c70000;"></span>Urgence - 4</div></div><p class="text-secondary"><small>Source: <a href="https://www.ipcinfo.org/ipc-country-analysis/details-map/en/c/1157971/?iso3=HTI" target="_blank" rel="noopener noreferrer">IPC</a></small></p>',
      location: {
        center: [-72.8, 18.88663],
        zoom: 7.5,
        mobileZoom: 6,
    ...
    },
    {
      ...
      title: '',
      image: '',
      description: "<h5>Chili</h5><p>Suite au tremblement de terre de 2010 qui a durement touché Haïti, le Chili a adopté différentes mesures pour faciliter la régularisation des Haïtiens sur son territoire, y compris des visas temporaires et des mesures visant à faciliter le regroupement familial. Le nombre de ressortissants haïtiens au Chili a fortement augmenté depuis, avec un total de 184&nbsp721 Haïtiens au Chili, sur la base des chiffres officiels de décembre 2022. Malgré les difficultés rencontrées pour satisfaire aux exigences de demande de visas pour la résidence permanente, en 2023, les Haïtiens représentaient le deuxième plus grand nombre de demandes de résidence permanente, avec 25&nbsp799 demandes.</p>",
      location: {
        center: [-70, -34],
        zoom: 3.5,
        mobileZoom: 2.2,
...
var config3 = {
  ...
  chapters: [[
    ...
    },
    {
      ...
      title: '',
      image: '',
      description: '<p>La salud y la seguridad alimentaria en Haití también se encuentran en niveles críticos. Casi la mitad de la población se encuentra en <a href="https://www.ipcinfo.org/ipc-country-analysis/details-map/en/c/1157971/?iso3=HTI" target="_blank" rel="noopener noreferrer">situación de inseguridad alimentaria grave, con 2 millones de personas en estado de emergencia</a>. La proyección actualizada de la Clasificación Integrada de las Fases de la Seguridad Alimentaria (CIF) de septiembre de 2024 muestra un empeoramiento de la inseguridad alimentaria, con cerca de 1,2 millones de personas más en situación de inseguridad alimentaria aguda en comparación con las estimaciones anteriores.</p><div class="legend mb-3"><h5 class="legend-title">Clasificación de la fase de inseguridad alimentaria aguda de la CIF</h5><div class="legend-category"><span style="background-color: #e67700;"></span>Crisis - 3</div><div class="legend-category"><span style="background-color: #c70000;"></span>Emergencia - 4</div></div><p class="text-secondary"><small>Fuente: <a href="https://www.ipcinfo.org/ipc-country-analysis/details-map/en/c/1157971/?iso3=HTI" target="_blank" rel="noopener noreferrer">CIF</a></small></p>',
      location: {
        center: [-72.8, 18.88663],
        zoom: 7.5,
        mobileZoom: 6,
