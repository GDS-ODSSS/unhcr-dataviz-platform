...
#plot the chart
fig, ax = plt.subplots()
plt.scatter(ordered_df['before_covid'], wrapped_label, color='#8EBEFF', label='before_covid')
plt.scatter(ordered_df['first_months'], wrapped_label, color='#0072BC', label='first_months')
