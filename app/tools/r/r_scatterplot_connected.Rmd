...
```{r r_scatterplot_connected, echo=FALSE, out.width="100%", fig.height=6.2, fig.alt="A connected scatterplot showing evolution of refugee vs IDP population in Afghanistan | 2001-2021"}
# Loading data
df <- read_csv("https://raw.githubusercontent.com/GDS-ODSSS/unhcr-dataviz-platform/master/data/correlation/scatterplot_connected.csv")
