...
```{r r_column_chart, echo=FALSE, out.width="100%", fig.height=5.8, fig.alt="A column chart showing the total displaced population from 2011 to 2021"}
# Loading data
df <- read_csv("https://raw.githubusercontent.com/GDS-ODSSS/unhcr-dataviz-platform/master/data/comparison/column.csv")
...
```{r r_column_labels_chart, echo=FALSE, out.width="100%", fig.height=5.8, fig.alt="A column chart showing the total displaced population from 2011 to 2021"}
# Loading data
df <- read_csv("https://raw.githubusercontent.com/GDS-ODSSS/unhcr-dataviz-platform/master/data/comparison/column.csv")
