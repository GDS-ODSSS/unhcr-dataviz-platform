...
```{r bar_code, echo=TRUE, eval=FALSE}
...
```{r r_bar_chart, echo=FALSE, out.width="100%", fig.height=5.8, fig.alt="A bar chart showing people displaced across borders by country of origin | 2020"}
# Loading data
df <- read_csv("https://raw.githubusercontent.com/GDS-ODSSS/unhcr-dataviz-platform/master/data/comparison/bar.csv")

ggplot(df) +
  geom_col(aes(x = displaced_number, y = reorder(country_origin, displaced_number)),
    fill = unhcr_pal(n = 1, "pal_blue"),
    width = 0.8
  ) +
  labs(
...
```{r bar_labels_code, echo=TRUE, eval=FALSE}
# Loading required packages
library(unhcrthemes)
library(tidyverse)
library(scales)
...
```{r r_bar_labels_chart, echo=FALSE, out.width="100%", fig.height=5.8, fig.alt="A bar chart showing people displaced across borders by country of origin | 2020"}
# Loading data
df <- read_csv("https://raw.githubusercontent.com/GDS-ODSSS/unhcr-dataviz-platform/master/data/comparison/bar.csv")
...
ggplot(df) +
  ...
  geom_text(aes(
    x = displaced_number, y = reorder(country_origin, displaced_number),
    label = round(displaced_number / 1e6, 2)
  ),
  hjust = -0.5, size = 11.5 / .pt
  ) +
  labs(
    title = "People displaced across borders by country of origin | 2021",
    subtitle = "Number of people (in million)",
