...
# Plot
ggplot(filter(df, population_type == "REF")) +
  geom_line(aes(x = year, y = population_number,
                group = population_type), size = 1,
            color = unhcr_pal(n = 1, "pal_blue")) +
  labs(title = "Number of refugees | 1991-2021",
       y = "Number of people",
...
```{r r_line_chart, echo=FALSE, out.width="100%", fig.height=5.8}
# Loading data
df <- read_csv("https://raw.githubusercontent.com/GDS-ODSSS/unhcr-dataviz-platform/master/data/change_over_time/line.csv")
...
```{r r_line_multi_chart, echo=FALSE, out.width="100%", fig.height=5.8}
# Loading data
df <- read_csv("https://raw.githubusercontent.com/GDS-ODSSS/unhcr-dataviz-platform/master/data/change_over_time/line.csv")
