...
ggplot(df) +
  geom_col(aes(x = year, y = displaced_number),
           ...
           width = 0.8) +
  labs(title = "Total displaced population | 2011 - 2021",
...
```{r r_column_chart, echo=FALSE, out.width="100%", fig.height=5.8, fig.alt="A column chart of the total displaced population form 2011 to 2021"}
# Loading data
df <- read_csv("https://raw.githubusercontent.com/GDS-ODSSS/unhcr-dataviz-platform/master/data/comparison/column.csv")
...
```{r column_labels_code, echo=TRUE, eval=FALSE}
# Loading required packages
library(unhcrthemes)
library(tidyverse)
library(scales)
...
ggplot(df) +
  geom_col(aes(x = year, y = displaced_number),
           fill = unhcr_pal(n = 1, "pal_blue"),
           width = 0.8) +
  geom_text(aes(x = year, y = displaced_number, label = round(displaced_number / 1e6, 1)),
            vjust = -1, size = 8/.pt) +
  labs(title = "Total displaced population | 2011 - 2021",
...
```{r r_column_labels_chart, echo=FALSE, out.width="100%", fig.height=5.8, fig.alt="A column chart of the total displaced population form 2011 to 2021 including labels"}
# Loading data
df <- read_csv("https://raw.githubusercontent.com/GDS-ODSSS/unhcr-dataviz-platform/master/data/comparison/column.csv")
