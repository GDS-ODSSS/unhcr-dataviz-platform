...
```{r choropleth_map_code, echo=TRUE, eval=FALSE}
...
```{r r_choropleth_map, echo=FALSE, error=FALSE, results='hide', out.width="100%", fig.height=5}
# Data URL
...
ggplot() +
  ...
  labs(
    title = "Global Refugee displacement by country of origin | 2021",
    caption = "The boundaries and names shown and the designations used on this map do not imply official endorsement\nor acceptance by the United Nations.\nSource: UNHCR Refugee Data Finder\n© UNHCR, The UN Refugee Agency"
  ) +
  coord_sf(crs = st_crs('ESRI:54030'),
           expand = FALSE) +
  theme_unhcr_map(font_size = 13)
```
