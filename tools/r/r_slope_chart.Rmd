...
```{r r_slope_chart, echo=FALSE, out.width="100%", fig.height=7.5, fig.alt="A slope chart showing evolution of refugee in East and Horn of Africa region | 2016 vs 2021"}
# Loading data
df <- read_csv("https://raw.githubusercontent.com/GDS-ODSSS/unhcr-dataviz-platform/master/data/change_over_time/slope.csv")
