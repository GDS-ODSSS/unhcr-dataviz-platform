...
df = pd.read_csv('https://raw.githubusercontent.com/GDS-ODSSS/unhcr-dataviz-platform/master/data/part_to_a_whole/donut.csv')
...
#plot the chart
fig, ax = plt.subplots()
pie=ax.pie(values, labels=labels, autopct='%1.1f%%', pctdistance = 0.75, counterclock=False, startangle=-270, textprops={'color':"#333333", 'fontsize':11, 'fontweight':'bold'}, colors=['#0072BC', '#8EBEFF'])
