...
rects1 = ax.bar(x - width, category1, width, color='#18375F', label='East and Horn of Africa and Great Lakes')
rects2 = ax.bar(x, category2, width, color='#0072BC', label='Southern Africa')
rects3 = ax.bar(x + width, category3, width, color='#8EBEFF', label='West and Central Africa')
...
label = "{:.1f}M".format(category1*1e-6)

ax.bar_label(rects1, labels=[f'{x:,.0f}' for x in rects1.datavalues], padding=3,color='#333333', fontsize=10)
ax.bar_label(rects1, labels=[f'{x:,.0f}' for x in rects2.datavalues], padding=3,color='#333333', fontsize=10)
ax.bar_label(rects1, labels=[f'{x:,.0f}' for x in rects3.datavalues], padding=3,color='#333333', fontsize=10)
