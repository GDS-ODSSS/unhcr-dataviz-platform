...
#plot the chart
fig, ax = plt.subplots()
ax.bar(x, y1, color='#0072BC', edgecolor='white', label='UNHCR resettlement')
ax.bar(x, y2, color='#8EBEFF', edgecolor='white', bottom=y1, label='Other resettlement')
...
#plot the chart
fig, ax = plt.subplots()
rect1=ax.bar(x, y1, color='#0072BC', edgecolor='white', label='UNHCR resettlement')
rect2=ax.bar(x, y2, color='#8EBEFF', edgecolor='white', bottom=y1, label='Other resettlement')
