...
#plot the chart
fig, ax = plt.subplots()
ax.stackplot(x, category1, category2, labels = ['IDPs', 'Refugees'], colors = ['#00B398','#0072BC'])

#set chart legend
ax.legend(loc=(0,0.95), ncol=2, borderpad=0, frameon=False, fontsize=10, labelcolor='#333333')
