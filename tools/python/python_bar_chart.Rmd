...
#set chart title
ax.set_title('People displaced across borders by country of origin | 2020', fontsize=14, fontweight='bold', loc='left', pad=35, color = '#000000')

#set subtitle
plt.suptitle('Number of people in millions', x=0.348, y=0.88, fontsize=11, color='#333333')

# set formatted data label
ax.bar_label(bar_plot, labels=[f'{x*1e-6:,.1f}' for x in bar_plot.datavalues], padding=3,color='#333333', fontsize=10)
